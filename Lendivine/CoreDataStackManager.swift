...
//        do {
//            _ = try CoreDataStackManager.sharedInstance().cartContext.save()
//            
//        } catch let error1 as NSError {
//            error.memory = error1
...
//        let error: NSErrorPointer = nil
//        do {
//            _ = try CoreDataStackManager.sharedInstance().accountContext.save()
//            
//        } catch let error1 as NSError {
//            error.memory = error1
//            print("Error saving cartContext: \(error)")
...
//        let error: NSErrorPointer = nil
//        do {
//            _ = try CoreDataStackManager.sharedInstance().countriesContext.save()
//            
//        } catch let error1 as NSError {
//            error.memory = error1
//            print("Error saving cartContext: \(error)")
