...
class KivaAPI {
    ...
    init(oAuthAccessToken: String, oAuth1: OAuth1Swift) {
        self.oAuthAccessToken = oAuthAccessToken
        self.oAuth1 = oAuth1
    }
    
    func makeKivaAPIRequest(urlOfAPI url: String, parametersDict: [String: AnyObject]?, completionHandler: (success: Bool, error: NSError?, jsonData: AnyObject?) -> Void ) {
...
// MARK: Convenience methods for Kiva API

extension KivaAPI {
    
    func kivaGetUserAccount(completionHandler: (success: Bool, error: NSError?, userAccount: KivaUserAccount?) -> Void ) {
        print("\n***** Kiva API request: https://api.kivaws.org/v1/my/account.json *****\n")
        makeKivaAPIRequest(urlOfAPI: "https://api.kivaws.org/v1/my/account.json", parametersDict: nil) { success, error, jsonData in
            if success {
    ...
    func kivaGetUserBalance(completionHandler: (success: Bool, error: NSError?, balance: String?) -> Void ) {
        print("\n***** Kiva API request: https://api.kivaws.org/v1/my/balance.json *****\n")
        makeKivaAPIRequest(urlOfAPI: "https://api.kivaws.org/v1/my/balance.json", parametersDict: nil) { success, error, jsonData in
...
//            let balance = userBalance?.valueForKey("balance") as? String
    ...
    func kivaGetUserEmail(completionHandler: (success: Bool, error: NSError?, email: String?) -> Void ) {
        print("\n***** Kiva API request: https://api.kivaws.org/v1/my/email.json *****\n")
        makeKivaAPIRequest(urlOfAPI: "https://api.kivaws.org/v1/my/email.json", parametersDict: nil) { success, error, jsonData in
...
//            let email = userEmail?.valueForKey("email") as? String
    ...
    func kivaGetUserExpectedRepayment(completionHandler: (success: Bool, error: NSError?, expectedRepayment: String?) -> Void ) {
        print("\n***** Kiva API request: https://api.kivaws.org/v1/my/expected_repayments.json *****\n")
        makeKivaAPIRequest(urlOfAPI: "https://api.kivaws.org/v1/my/expected_repayments.json", parametersDict: nil) { success, error, jsonData in
    ...
    func kivaGetLender(completionHandler: (success: Bool, error: NSError?, lender: KivaLender?) -> Void ) {
        print("\n***** Kiva API request: https://api.kivaws.org/v1/my/lender.json *****\n")
        makeKivaAPIRequest(urlOfAPI: "https://api.kivaws.org/v1/my/lender.json", parametersDict: nil) { success, error, jsonData in
            if success {
    ...
    func kivaGetLoans(completionHandler: (success: Bool, error: NSError?, loans: [KivaLoan]?) -> Void ) {
        ...
        print("\n***** Kiva API request: https://api.kivaws.org/v1/my/loans.json *****\n")
        makeKivaAPIRequest(urlOfAPI: "https://api.kivaws.org/v1/my/loans.json", parametersDict: nil) { success, error, jsonData in
    ...
    func kivaGetMyLenderStatistics(completionHandler: (success: Bool, error: NSError?, statistics: KivaLoanStatistics?) -> Void ) {
        
        print("\n***** https://api.kivaws.org/v1/my/stats.json *****\n")
        makeKivaAPIRequest(urlOfAPI: "https://api.kivaws.org/v1/my/stats.json", parametersDict: nil) { success, error, jsonData in
    ...
    func kivaGetLoanBalances(loanID: NSNumber, completionHandler: (success: Bool, error: NSError?, balances: [String]? /*TODO: change type*/) -> Void ) {
        ...
        makeKivaAPIRequest(urlOfAPI: "https://api.kivaws.org/v1/my/loans/:ids/balances.json", parametersDict: nil /*parametersDict*/) { success, error, jsonData in
...
//                        statistics = KivaLoanBalance(dictionary: jsonData as? [String: AnyObject])
    ...
    func kivaGetMyTeams(completionHandler: (success: Bool, error: NSError?, teams: [KivaTeam]?) -> Void) {
        ...
        makeKivaAPIRequest(urlOfAPI: "https://api.kivaws.org/v1/my/teams.json", parametersDict: nil /*parametersDict*/) { success, error, jsonData in
...
*/
    ...
    func kivaGetPartners(completionHandler: (success: Bool, error: NSError?, partners: [KivaPartner]?) -> Void) {
        ...
        makeKivaAPIRequest(urlOfAPI: "http://api.kivaws.org/v1/partners.json", parametersDict: nil /*parametersDict*/) { success, error, jsonData in
...
extension KivaAPI {
    ...
    func kivaGetNewestLoans(completionHandler: (success: Bool, error: NSError?, loans: [KivaLoan]?) -> Void) {
        ...
        makeKivaAPIRequest(urlOfAPI: "http://api.kivaws.org/v1/loans/newest.json", parametersDict: nil /*parametersDict*/) { success, error, jsonData in
    ...
    */
    func kivaSearchLoans(queryMatch queryMatch: String?, status: String?, gender: LoanGender?, regions: String?, countries: String?, sector: LoanSector?, borrowerType: String?, maxPartnerRiskRating: PartnerRiskRatingMaximum?, maxPartnerDelinquency: PartnerDelinquencyMaximum?, maxPartnerDefaultRate: PartnerDefaultRateMaximum?, includeNonRatedPartners: Bool?, includedPartnersWithCurrencyRisk: Bool?, page: NSNumber?, perPage: NSNumber?, sortBy: String?, completionHandler: (success: Bool, error: NSError?, loans: [KivaLoan]?) -> Void) {
        ...
        makeKivaAPIRequest(urlOfAPI: "http://api.kivaws.org/v1/loans/search.json", parametersDict: parametersDictionary) { success, error, jsonData in
...
extension KivaAPI {
    ...
    func KivaAddItemToCart(loanID: NSNumber?, amount: NSNumber?) {
        if let loanID = loanID {
            if let amount = amount {
                let cart = KivaCart.sharedInstance
                let item = KivaCartItem(loanID: loanID, amount: amount)
                cart.add(item)
            }
        }
    }
